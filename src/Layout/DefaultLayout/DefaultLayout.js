...
function DefaultLayout({
    ...
    return (
        <div className="overflow-hidden">
            {banner && (
                <div
                    className={`relative w-full bg-cover bg-center flex flex-col text-white ${
            ...
            <div
                className={clsx(
                    '[&>*]:w-full relative w-full xl:w-[1200px] mx-auto px-4 sm:px-6 lg:px-12 xl:px-0 flex flex-col',
                    noContentSpacing ? 'pt-0 my-0' : 'pt-[120px] my-[54px]',
                )}
            >
                {children}
            </div>
